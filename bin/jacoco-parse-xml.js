        ...
        for(var i = 0; i < result.report.counter.length; i++) {
            ...
            switch(item.type) {
                case 'LINE':
                    ...
                    console.log("##teamcity[buildStatisticValue key='CodeCoverageLPercentage' value='%s']", item.covered * 1.0 / total);
                break;
                ...
                case 'METHOD':
                    ...
                    console.log("##teamcity[buildStatisticValue key='CodeCoverageMPercentage' value='%s']", item.covered * 1.0 / total);
                break;
                ...
                case 'CLASS':
                    ...
                    console.log("##teamcity[buildStatisticValue key='CodeCoverageCPercentage' value='%s']", item.covered * 1.0 / total);
                break;
            }
        }
    });
